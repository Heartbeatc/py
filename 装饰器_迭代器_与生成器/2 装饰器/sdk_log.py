...
def main():
    endpoint = 'pn-test.cn-shenzhen-intranet.log.aliyuncs.com'       # 选择与上面步骤创建Project所属区域匹配的Endpoint
    accessKeyId = 'LTAIkj05iklatUfc'    # 使用您的阿里云访问密钥AccessKeyId
    accessKey = 'spd6QKZyZXvg2d3r2nqMCm8IlFjGMV'      # 使用您的阿里云访问密钥AccessKeySecret
    project = 'pn-test'        # 上面步骤创建的项目名称
    logstore = 'app_test'       # 上面步骤创建的日志库名称
